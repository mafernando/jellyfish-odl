(function() {
  ...
  function appRun(StateOverride) {
    StateOverride.override('services.details', function(service) {
      if ('JellyfishOdl::Service::RouterV4' == service.type) {
        return {
          templateUrl: 'extensions/odl/states/services/details/odl/router_v4/router_v4.html',
  ...
  function StateController($scope, service, OdlData) {
    ...
    function handleResults(data) {
      ...
      try {
        ...
        var policies = data[0]['vyatta-security-firewall-v1:name'];
    ...
    function handleAllResults(data) {
      ...
      try {
        // GET FIREWALL POLICIES
        var policies = data[0]['vyatta-security-firewall-v1:firewall']['name'];
